...
![Simple](https://img.shields.io/badge/界面-纯净无广-lightgrey)
...
> 界面更美观，功能更完整，额外支持**车辆海报一键下载**功能，体验更佳。
...
- 🏆 **圈内唯一**：目前《极品飞车：集结》玩家圈内唯一一款车辆数据查询工具。
- ⚡ **告别翻推文**：以往查询已上线的车辆信息只能去官方微信公众号翻阅历史推文，十分麻烦，现在打开工具即可秒查，节省大量时间。
- 📴 **离线可用**：数据本地化，无网络也能畅快查询。
- 🔒 **隐私安全**：本地查询，不收集用户任何个人信息。
- 💯 **永久免费**：无内购、无订阅。
...
- **联网说明**：软件仅在**安装后首次打开或数据更新**时需要连接网络，日常查询无需联网。
- **问题反馈**：欢迎前往 [Issues](https://github.com/IDStudy/NFS-car_data-system/issues) 或抖音评论区留言，请附上**截图和详细问题描述**，帮助我高效解决。
